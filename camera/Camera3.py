...
def CAM():
	if (int(datetime.datetime.now().strftime("%H")) >= 17 or int(datetime.datetime.now().strftime("%H")) < 7):
		t=datetime.datetime.now().strftime("%Y%m%d%H%M%S")
		file = '/home/pi/Desktop/Picode/camera/images/MyGarden'+t+'.jpg'
		print(file)
		if (int(datetime.datetime.now().strftime("%H")) >= 17 or int(datetime.datetime.now().strftime("%H")) < 6):
